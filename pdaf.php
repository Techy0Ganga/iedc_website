...
if(isset($_POST['submitbutton']))
{
    ...
    $pdf->Image('pictures/pdfhead.png',55,10,100);
    $pdf->Ln(20);
    ...
    $pdf->SetFont('Poppins-Medium','',10);
    $pdf->MultiCell(0,5,'I understand that 75% physical presence is mandatory to attend the examination. I also ensure that I will make up the sessions I missed in consultation with faculty. I shall keep the decorum and code of conduct as a student of College of Engineering Thalassery one the day mentioned above.');
    $pdf->Ln(5);
